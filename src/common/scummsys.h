...
// Define a compatibility macro for dealing with the explicit bool problem.
// There could be a more-robust hack for C++98, but this should do for now.
#if __cplusplus < 201103L
#define CABAL_EXPLICIT_OPERATOR_CONV
#else
#define CABAL_EXPLICIT_OPERATOR_CONV explicit
#endif
...
//
	...
	#elif defined(__RP2350__) || defined(PICO_ON_DEVICE)
		// RP2350 (Raspberry Pi Pico 2) - ARM Cortex-M33, little endian
		#define SCUMM_LITTLE_ENDIAN
		#define SCUMM_NEED_ALIGNMENT
